...
struct IndexIVFPQ: IndexIVF {
    ...
    std::vector < std::vector<uint16_t> > codes; // binary codes, size nlist
    ...
    void encode (long key, const float * x, uint16_t * code) const;
...
struct IndexIVFPQR: IndexIVFPQ {
    ...
    std::vector <uint16_t> refine_codes;   ///< corresponding codes
...
struct IndexIVFPQCompact: IndexIVFPQ {
    ...
    uint16_t *compact_codes;  ///< size ntotal * code_size
